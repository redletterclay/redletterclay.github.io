...
export interface Post {
  ...
  /**
   * Raw markdown body (imported from Jekyll)
   */
  body?: string | null;
  /**
  ...
  /**
   * Optional. Overrides the auto-generated YouTube thumbnail. Recommended size: 1280×720px (16:9).
   */
  videoThumb?: (number | null) | Media;
  gallery?:
    | {
        items?:
          | {
...
export interface Media {
  ...
  /**
   * Set automatically by the seed script
   */
...
export interface Product {
  ...
  tags?: ('display' | 'drink' | 'eat' | 'plant' | 'pour' | 'store')[] | null;
  firingMethod?: ('electric-6' | 'gas-10') | null;
  makingLinks?:
    | {
        title: string;
        url: string;
